...
\journal{Journal of Applied Energy} % May or May not 
...
%% simple marking / comment 
\newcommand{\gil}[1]{\textbf{Gil: #1}\\}
\newcommand{\todo}[1]{\textbf{TODO: #1}\\}

\begin{frontmatter}

\title{An Investigation on Hybrid Energy Grid Optimization\tnoteref{mytitlenote}}
\tnotetext[mytitlenote]{This paper is an extend version of .}
...
%\address[AIT]{AIT, Vienna, Austria} 
